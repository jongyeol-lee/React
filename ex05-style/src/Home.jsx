...
// styled이 적용된 컴포넌트를 만들어주는 객체를 import
    ...
    render(){
        return(
            <div>
                ...
                <p className={homeStyle.bb}>모듈 클래스 선택자 연습</p>
                <hr />
                ...
                {/* 5) 외부 스타일 라이브러리 - styled-components [설치 필요npm install styled-components]*/}
                {/* 사용하려면 import 해야 함. */}
...
const WebButton= styled.button`
    ...
    //스타일이 된 버튼에 지정된 속성을 받아서 특정 기능으로 처리할 수 있음.
