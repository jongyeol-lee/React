...
function Home(){
    ...
    const submitGet= (event)=>{
        ...
        //분리하여 작엄함. 그리고 react 프로젝트는 npm run build를 통해 dist폴더를 배포함
        ...
        //리액트를 배포하려면..npm run build로 배포용 dist폴더를 만드록
    ...
    //전달받은 값이 fruits배열에 있으면 제거. 없으면 추가하는 함수
    ...
    return (
        <div>
            ...
            <form onSubmit={submitFile}>
                {/* 모바일 브라우저에서 이 버튼을 누르면 화면 하단에 [앱선택 (카메라,갤러리)] BottomSheet로 제공됨 */}
