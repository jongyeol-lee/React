...
import kitten from './kitten-2.jpg'
import kitty from './assets/kitten-1.jpg'
...
class HomeComponent extends Component{
    ...
    render(){
        return (
            <div>
                ...
                <img src="./kitten-2.jpg" alt="고양이 이미지" />
                {/* (해결) src 폴더의 이미지를 .jsx파일에서 불러와서 보여줘야함. import */}
                <img src={kitten} alt="고양이 이미지" width={150} />
                {/* 2) src폴더 안에 이미지파일을 위치하면 파일이 너무많아서 식별이 어려움. 그래서 src/assets폴더안에 이미지를 위치할 것을 권장 */}
                <img src={kitty} alt="고양잉 이미지" width={150} />

                {/* 3)public 폴더는 index.html이 바라보는 본인 폴더위치임. */}
                {/* public 폴더에 이미지파일을 위치하고 사용해보기 */}
                <img src="./ms18.png" alt="달팽이 이미지" width={150} />
                ...
                <img src={this.state.image} alt="고양이" width={200} />
    ...
    changeImage= ()=>this.setState({image:kitty})
